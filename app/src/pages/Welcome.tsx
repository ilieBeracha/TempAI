          ...
          <div className="relative max-lg:row-start-1">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm text-gray-600 max-lg:text-center">
                  Choose between a grid, single-column, or template layout.
                </p>
              </div>
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm text-gray-600 max-lg:text-center">
                  Add headers, footers, content blocks, and more to each
                  section.
                </p>
              </div>
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm text-gray-600 max-lg:text-center">
                  Interact with AI for real-time ideas and generated content.
                </p>
              </div>
                  ...
                  <div className="flex bg-gray-800/40 ring-1 ring-white/5">
                    <div className="-mb-px flex text-sm font-medium leading-6 text-gray-400">
                      ...
                      <p className="mt-2 max-w-lg text-sm text-gray-600 text-center">
                        Review your layout in real-time, make adjustments, and
                        save your design.
                      </p>
                    </div>
                  </div>
